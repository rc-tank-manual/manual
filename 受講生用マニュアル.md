...
## 2.　ラジコン戦車の車体を組み立てよう
  ...
  + ##### 2.1 ギヤボックスを組み立てよう
    ...
    + ###### 2.1.2 ギヤボックスを組み立てよう
      ...
      **E** ギアを組み合わせる（4枚画像）
     <div align="center"> 
      <img src="http://ais.nsc.nagoya-cu.ac.jp/wp-content/uploads/2021/07/2.1.2.E1.jpg" style="zoom:20%;transform:rotate(90deg);"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<img src="http://ais.nsc.nagoya-cu.ac.jp/wp-content/uploads/2021/07/2.1.2.E2.jpg" style="zoom:20%;" />
...
## 3.　ラジコン戦車の制御部を作ろう(アシスタントのみ)
  ...
  + ##### 3.1 Raspberry Pi0を設定しよう
    ...
    + ###### 3.1.2 [Raspian](https://www.raspberrypi.org/software/operating-systems/#raspberry-pi-os-32-bit)をmicroSDカードに入れよう
     ...
     <div align="center"> 
      <img src="http://ais.nsc.nagoya-cu.ac.jp/wp-content/uploads/2021/07/3.1.2.jpg" style="zoom:50%;" />
     </div>
